...
class IdleState:
    ...
    def enter(boy, event):
        if event == RIGHT_DOWN:
            ...
            boy.velocity += RUN_SPEED_PPS
        elif event == SPACE and boy.jump == False and boy.air ==False:
            boy.firstY = boy.y
            boy.jump = True
        boy.timer = 1000
...
class Boy:
    ...
    def __init__(self):
        ...
        self.jumpY = 0
        self.air = False
        self.gravity = RUN_SPEED_PPS

    def get_bb(self):
        return self.x - 15, self.y - 37, self.x + 15, self.y + 45
